...
class CircularLinkedList:
    """
    A class implementing a circular linked list.
    """
    ...
    def next(self):
        """
        Move the current node of the list.
        """
    ...
    def __str__(self):
        """
        Create a string representation of the circular linked list.
        :return: a string representing a circular linked list
        """
...
if __name__ == "__main__":
    ...
    # Create a circular linked list: 1 -> 3 -> 2.
